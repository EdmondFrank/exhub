defmodule GiteeCat do
  ...
  defp extra_options do
    Application.get_env(:gitee_cli, :request_options, [])
  end

  defp extra_headers do
    Application.get_env(:gitee_cli, :extra_headers, [])
  end

  defp deserialization_options do
    Application.get_env(:gitee_cli, :deserialization_options, labels: :binary)
  end
  ...
  def authorization_header(%{cookie: cookie}, headers) do
