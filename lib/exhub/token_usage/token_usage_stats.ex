defmodule Exhub.TokenUsage.TokenUsageStats do
  ...
  @default_pricing %{
    ...
    "qwen3.6-27b" => %{input: 0.15, output: 0.75},
    "qwen3.6-35b-a3b" => %{input: 0.13, output: 0.65},
    "qwen3.7-plus" => %{input: 0.35, output: 1.75},
    "qwen3.7-max" => %{input: 0.78, output: 3.9},
    # Kimi / Moonshot
    ...
    "glm-4.7-flash" => %{input: 0.15, output: 0.6},
    "glm-4.5-air" => %{input: 0.3, output: 1.2},
