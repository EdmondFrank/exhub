defmodule Exhub.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Exhub.MCP.HabitServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Time Server
      {Exhub.MCP.TimeServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Think Server
      {Exhub.MCP.ThinkServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Web Tools Server
      {Exhub.MCP.WebToolsServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Archery Server (SQL audit platform)
      {Exhub.MCP.ArcheryServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # Kuri Daemon — auto-starts the kuri HTTP server (Chrome CDP backend) via Exile
      Exhub.KuriDaemon,
      # MCP Browser Server
      {Exhub.MCP.BrowserUseServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Image Generation Server
      {Exhub.MCP.ImageGenServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Document Extraction Server (PDF, DOCX, images via Gitee AI PaddleOCR-VL-1.5)
      {Exhub.MCP.DocExtractServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Look Server (image understanding via Gitee AI vision models)
      {Exhub.MCP.LookServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Listen Server (audio transcription via Gitee AI / moark.com)
      {Exhub.MCP.ListenServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Todo Server (multi-tenant, 2-hour expiry)
      {Exhub.MCP.TodoStore, name: Exhub.MCP.TodoStore},
      {Exhub.MCP.TodoServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Desktop Server (filesystem, process, search tools)
      {Exhub.MCP.Desktop.ProcessStore, name: Exhub.MCP.Desktop.ProcessStore},
      {Exhub.MCP.DesktopServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Agent Server (ACP agent management)
      {Exhub.MCP.Agent.Store, name: Exhub.MCP.Agent.Store},
      {Exhub.MCP.AgentServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Brain Server (Obsidian vault as second brain)
      {Exhub.MCP.BrainServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Exhub Self-Management Server (compile, reload, restart, status)
      {Exhub.MCP.ExhubServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Mac-use Server (macOS native app automation via axcli / Accessibility API)
      {Exhub.MCP.MacUseServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      # MCP Emacs Server (buffer operations via WebSocket)
      {Exhub.MCP.EmacsServer, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
      ...
      {Exhub.MCP.Hub.Server, transport: :streamable_http, request_timeout: 600_000, session_idle_timeout: 86_400_000 * 365},
