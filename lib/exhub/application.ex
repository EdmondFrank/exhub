defmodule Exhub.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Exhub.MCP.ListenServer, transport: :streamable_http, request_timeout: 120_000, session_idle_timeout: 86_400_000 * 365},
      ...
      {Exhub.MCP.EmacsServer, transport: :streamable_http, request_timeout: 120_000, session_idle_timeout: 86_400_000 * 365},
