...
case SecretVault.Config.fetch_from_current_env(:exhub) do
  {:ok, vault_config} ->
    ...
    llms_config = %{
      ...
      "openai/qwen3.6-max" => gitee_llm.("openai/qwen3.6-max"),
      "openai/qwen3.6-plus" => gitee_llm.("openai/qwen3.6-plus"),
      "openai/qwen3.5-9b" => gitee_llm.("openai/qwen3.5-9b"),
      "openai/qwen3.5-27b-pro" => gitee_llm.("openai/qwen3.5-27b-pro"),
      "openai/qwen3-coder-30b-a3b-instruct" => gitee_llm.("openai/qwen3-coder-30b-a3b-instruct"),
      "openai/qwen3-30b-a3b-instruct-2507" => gitee_llm.("openai/qwen3-30b-a3b-instruct-2507"),
      ...
      "openai/deepseek-v4-pro" => gitee_llm.("openai/deepseek-v4-pro"),
